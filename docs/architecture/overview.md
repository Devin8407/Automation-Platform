...
- [**ADR-006:** Dependency Based Workflow Scheduling](../adr/ADR-008-dependency-based-workflow-scheduling)
- [**ADR-008:** Unit of Work for transaction Management](../adr/ADR-007-unit-of-work-for-transaction-management.md)
