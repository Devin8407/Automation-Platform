...
- [**ADR-005:** Separate Definitions from Execution State](ADR-005-separate-definitions-from-execution-state.md)
- [**ADR-006:** Dependency Based Workflow Scheduling](ADR-008-dependency-based-workflow-scheduling)
- [**ADR-007:** Domain Model Independent of Persistence](ADR-006-domain-model-independent-of-persistence.md)
- [**ADR-008:** Unit of Work for transaction Management](ADR-007-unit-of-work-for-transaction-management.md)
